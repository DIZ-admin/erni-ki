...
**Версия LiteLLM:** v1.80.0.rc.1  
**Redis Caching:** ОТКЛЮЧЕН (используем локальный кеш)  
**Причина отключения Redis:** баг с hardcoded `socket_timeout: 5.0` в
v1.80.0.rc.1
...
**Workaround:** Использовать локальный (in-memory) кеш вместо Redis до
исправления в следующих версиях LiteLLM.
...
- [LiteLLM Official Docs](https://docs.litellm.ai/docs/caching/getting-started)
