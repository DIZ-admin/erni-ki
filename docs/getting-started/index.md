...
configuration -**[local-network-dns-setup.md](local-network-dns-setup.md)**-
Local DNS
setup -**[dnsmasq-setup-instructions.md](dnsmasq-setup-instructions.md)**-
DNSMasq guide -**[port-forwarding-setup.md](port-forwarding-setup.md)**- Port
forwarding guide

## Quick Start Path

1.**Installation:**Follow [installation.md](installation.md) (~30
minutes) 2.**Configuration:**Review
[configuration-guide.md](configuration-guide.md) 3.**First Use:**Read
