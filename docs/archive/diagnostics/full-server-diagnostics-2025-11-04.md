...
> завышен на **98.6%** из-за неправильной методологии grep. **Реально:** 657
...
3. ~~ **КРИТИЧНО**: Исправить 1,178 ошибок в Fluent Bit~~ → **ЛОЖНАЯ ТРЕВОГА**
   (JSON логи от других сервисов)
4. **ВЫСОКИЙ**: Установить pg_stat_statements для мониторинга PostgreSQL (30
   мин)
5. **ВЫСОКИЙ**: Исправить невалидный config.json в Backrest (30 мин)
...
1. **Исправить webhook-receiver** - 7,114 ошибок требуют немедленного внимания
2. **Исправить node-exporter** - 36,405 ошибок указывают на серьёзную проблему
3. **Исправить SearXNG** - 1,204 ошибки влияют на RAG функциональность
4. **Исправить Fluent Bit** - 1,178 ошибок нарушают централизованное логирование
