...
**Дата:** 2025-10-30 **Версия:** 1.0 **Автор:** ERNI-KI Test Suite **Статус:**
УСПЕШНО ЗАВЕРШЕНО
...
**Файл:** `.config-backup/test-documents/rag-test-document.pdf` **Размер:** 101
KB (103,377 bytes) **Формат:** PDF 1.5 **Страниц:** 2
