...
-**Аудиты**— см. `archive/audits/README.md` -**Диагностика**— см.
`archive/diagnostics/README.md` -**Инциденты**— см.
...
директорию + запись в её README. 2.**Обновить ссылки**в `mkdocs.yml` (раздел
«Отчёты и архив») и в `operations/core/operations-handbook.md`, если появился
новый отчёт. 3.**Зафиксировать итоги**в Archon task или отчёте (чтобы история
была связана). 4.**Раз в неделю**проверить, что config-backup отчёты
(monitoring/update) отражают текущее расписание cron и версии скриптов.
