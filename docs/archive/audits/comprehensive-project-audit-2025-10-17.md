...
- [WARNING] **OpenWebUI Redis ошибки** (97 за 24 часа): "invalid
...
- [WARNING] **Redis cache hit rate: 46.6%** (114427 hits / 245718 total)
...
- [OK] **Fluent Bit логирование:** Работает, но нет health check
- **Приоритет:** Низкий
...
- [OK] **Пароли в env файлах:** Не используются Docker Secrets
...
- [OK] **README.md:** Указано "30 микросервисов", но фактически 49 контейнеров
