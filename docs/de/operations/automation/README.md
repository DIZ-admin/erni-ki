...
- [automated-maintenance-guide.md](automated-maintenance-guide.md) — Zeitplan
  für tägliche/wöchentliche Aufgaben, Überwachung von Watchdog-Skripten,
  Richtlinie für den Autostart von Cron/systemd-Timern.
