...
1. ⚠️ **Ungenutzte Volumes prüfen** – potenziell ~16,36 GB
   - Inhalt jedes Volumes prüfen
   - Sicherstellen, dass keine wichtigen Daten enthalten sind
   - Erst nach Bestätigung löschen

2. ⚠️ **Alte Service-Images löschen** (elasticsearch, mysql, fluent-bit)
...
**Priorität:** Mittel (innerhalb einer Woche umsetzbar)
