...
1. Änderungen in RU (Kanon) vornehmen.
2. `doc_version`/`released` hier aktualisieren, Änderungen kurz notieren.
3. `translation_status` in EN/DE anpassen, sobald übersetzt.
4. Changelog-Eintrag ergänzen.
...
- RU: 88 Dateien — 100% (Kanon)
- DE: 60 Dateien (36 complete) ≈ 41%
- EN: 16 Dateien (5 complete) ≈ 6%

### Fokus Übersetzungen

- DE: Monitoring, Maintenance, Reference in Arbeit (22 pending).
- EN: Academy vollständig; Technik-Docs größtenteils fehlend.
