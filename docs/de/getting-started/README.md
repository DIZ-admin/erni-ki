...
# Erste Schritte mit ERNI-KI

Dieses Verzeichnis enthält wichtige Anleitungen zur Installation, Konfiguration
und Nutzung der ERNI-KI Plattform.
...
- Docker 20.10+
- 8GB RAM Minimum (32GB empfohlen)
- 50GB Speicher Minimum (200GB+ empfohlen)
- NVIDIA GPU optional (RTX 4060+ empfohlen)

## Verwandte Dokumentation

- [Architekturübersicht](../architecture/README.md)
- [Operations Guide](../operations/README.md)
- [Systemübersicht](../overview.md)
