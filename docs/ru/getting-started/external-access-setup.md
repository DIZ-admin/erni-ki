...
**Модель**: LANCOM (корпоративный роутер)**IP**: 192.168.62.1**Веб-интерфейс**:
<https://192.168.62.1/> (WEBconfig)**Доступ**: Требуются учетные данные
администратора
...
Proxied (оранжевое облако) -**TTL**: Auto
...
1.**Выбрать вариант решения**(рекомендуется Вариант 1) 2.**Получить доступ к
Cloudflare Dashboard**(для Варианта 1)

- ИЛИ -

  3.**Связаться с IT отделом**(для Варианта 2) 4.**Применить настройки**согласно
  выбранному варианту 5.**Протестировать доступ**с внешнего
  компьютера 6.**Обновить документацию**с результатами
