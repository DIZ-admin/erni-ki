...
-**Работает**— все сервисы в норме. -**Частично**— есть деградация, часть
функций недоступна. -**Обслуживание**— плановые работы, возможны перерывы. -**Не
работает**— критический простой, используйте резервные каналы.
