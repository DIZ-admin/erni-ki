...
Находит конкретную информацию в документах Сравнивает разделы документа
Извлекает facts и data points Цитирует источники Работает с structured
information

### Что RAG делает плохо:

Понимание very complex relationships Глубокий analytical reasoning поверх
документов Синтез информации из 10+ разных мест Понимание subtle context и
nuance Работа с таблицами и визуализациями (ограниченно)
