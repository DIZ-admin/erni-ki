...
> LiteLLM v1.80.0.rc.1, Docling, MCP Server, Apache Tika, Watchtower
...
**30 микросервисов**: OpenWebUI v0.6.36, Ollama 0.12.11 (GPU), LiteLLM
v1.80.0.rc.1 (Context Engineering), SearXNG, Docling, Tika, EdgeTTS, MCP Server,
Watchtower и полный стек наблюдаемости (Prometheus v3.0.1, Grafana v11.6.6,
Alertmanager v0.28.0, Loki v3.5.5, Fluent Bit v3.2.0, 8 экспортёров + RAG
