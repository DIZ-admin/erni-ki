...
- **[admin-guide.md](../../de/operations/core/admin-guide.md)** — admin handbook
  (users, config, backup/restore, security)
...
- **Automation:**
  [Automated maintenance](../../de/operations/automation/automated-maintenance-guide.md)
- **Database:** [Operations overview](index.md)
- **Monitoring:**
